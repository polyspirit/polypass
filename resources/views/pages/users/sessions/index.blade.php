        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('sessions.title') }}</h4>
                    <p class="text-muted mb-0">{{ __('sessions.description') }}</p>
                </div>
                <div class="card-body">
                    @if($sessions->count() > 0)
                        <div class="row mb-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        ...
                                                        <p class="card-text">
                                                            ...
                                                            <strong>{{ __('sessions.last_activity') }}:</strong> {{ $session->last_activity->diffForHumans() }}<br>
                                                            <strong>{{ __('sessions.user_agent') }}:</strong> {{ Str::limit($session->user_agent, 100) }}
                                                        </p>
                                                    </div>
                                        ...
                                        <div class="card border-warning mb-2">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 text-end">
                                                        <form action="{{ route('sessions.terminate', $session->session_id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
